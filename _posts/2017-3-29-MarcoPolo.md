...
### Capybara: a web-based test automation software 
...
### IFTTT: a web-based service to creates chains of simple conditional statements
...
### RaspberryPi: a tiny and affordable computer for doing fun things
